  ...
  <body>
    <header>
      ...
      <nav>
        <ul class="nav__links">
          ...
          <li class="histoire"><a href="PrintManager.php">Notre histoire</a></li>
          <li class="contact"><a href="MyProfile.php">Contact</a></li>
        </ul>
      </nav>
    ...
    <div class="container">
      <div class="texte">
        ...
        <p>Votre solution ultime pour une génération et<br> une gestion sécurisée des mots de passe !</p>
        <p>Inscrivez-vous dès maintenant pour enregistrer<br> et gérér vos mots de passe.</p>
